                ...
                <Grid item xs={12} md={8}>
                  ...
                  <FaqGroup>
                    ...
                    <Collapse list={[
                      ...
                      },
                      {
                        ...
                        answer: `<b>我們理解大型專案仍需經過必要的選商流程，但我們更相信，一個好設計，必須對要解決的問題有相當程度了解之後，才更有機會達成。</b>對於每個專案，大予會先投入相當的人力與時間，淬鍊出最好的設計。大予對於每個客戶的專案，是完全客製且獨特的，沒有模版也沒有捷徑，只有日積月累的專業能力和經驗。我們可先向您展示過去類似的案例作品，並協助您做內部溝通，說明我們會如何進行專案、預計交付的成果，及可能的設計方向。在一定的預算規模前提下，我們仍可依據客戶提供的邀稿/需求說明書 (RFP) 並與客戶充分溝通之後，提供服務建議書並參與選商。`,
                        expanded: false
                      },
                      {
                        title: "專案時程需花費多久？",
                        answer: `<b>視專案的規模與內容，以及當時人力狀況而定。平均約為3~6 個月。</b>一般而言，一個中型規模以上的 APP或網站專案，需要 4~6 週進行研究規劃，4~6 週完成 UX/UI 設計，以及額外的 4~8 週完成給圖作業或前端開發。通常開發人員在設計專案進行到中、後半段時就可以開始同步進行程式開發作業。若狀況允許，我們建議保留多點時間在前期的研究與規劃階段，包含設計重點、規格訂定、設計風格等，這些項目確認越清楚，後續細部設計與開發效率也會相對提昇。`,
                        expanded: false
                      },
                      {
                        title: "專案進行時，如何配合達到最好成效？",
                        answer: `<b>以專案小組與您充分討論溝通，更歡迎您與我們共同參與相關活動。</b>專案正式開始時，大予通常會組成專案小組並配置一位專案經理 (PM)，PM 將與您討論開案時需要準備的事項，包含盤點現有資源、安排利益關係人內訪、使用者分群與研究方法、專案管理方式等，並舉行開案會議 (kick-off meeting)。專案過程中如果包含使用者研究、訪談、測試，也將邀請您一起參與相關活動。另外，也需要貴公司協助安排提案會議、設計說明會議、交付驗收會議等，讓專案能夠如期如質的完成。`,
                        expanded: false
                      },
                      {
                  ...
                  <FaqGroup>
                    ...
                    <Collapse list={[
                      {
                        title: "報價如何計算？",
                        answer: `<b>UX/UI 設計的費用會根據專案特性、工作項目，以及使用到的職能種類來計價。</b>報價通常跟以下條件相關：<br/><ul><li><b style="display:contents">是否有明確的規格書？</b>如果沒有，在前期就需要花較多的時間協助客戶訂定產品策略與目標、規劃產品資訊架構、設計操作流程、繪製框架圖 (wireframe) 等。</li><li><b style="display:contents">產品/服務內容的多寡。</b>有些專案較著重在視覺表現，有些則注重使用流程，有些 icon 很多，或視覺layout 較複雜等。</li><li><b style="display:contents">專案的專業特性。</b>一些較特殊的產業或使用者對象，會花費較多的時間在研究和改善使用經驗，如果需要進行使用者訪談與測試等，則會產生額外費用。</li></ul><br/>大予在一開始，會儘可能蒐集相關資訊並依據實際工作項目與投入人員的職能、工時進行報價。通常一個手機 APP 的 UX/UI 設計案，預算從 150 萬到 500 萬都有；一個網站規劃與設計案，則落於200 萬到上千萬不等。但每個專案特性和狀態都不同，建議先進行整體評估之後，再進行報價。 <br/><br/>我們也與許多公司採年約方式合作。如果專案規模和數量並不明確，但又需要長期配合的設計夥伴，我們可根據案量配置適當的設計師人力，以實際發生的工時來計價 (time-base)。年約方案讓大予的設計師就像貴公司內部專屬設計師一樣，但此種合作模式較適合有一定的信任基礎，以及需要大予協助設計創新性質的專案。想暸解更多報價方式，歡迎與我們聯絡。`,
                        expanded: false
                      },
                      {
                        title: "報價之前，需要準備哪些資料？",
